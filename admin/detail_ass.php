...
<head>
    ...
    <title>Detail Data Assesment</title>
...
<body>
    <h2 class="page-header" style="text-align: center;"> Detail Data Assesment</h2>
    <div class="panel-body">
            <div class="container" style="text-align: right;">
            <a href="cetak_ass.php?id=<?php echo $data['nama']; ?>" class="btn btn-success" title="cetak"><span class="fa fa-download"> &nbsp Cetak</span></a>
            </div>
            <div class="container">
